...
export const Footer = () => {
  return (
    ...
    <div>
      <h2 className='text-lg font-semibold text-neutral-400'>Hey, We are Hiring!!! Be a part of Our Journey <a href="mailto:contact@avantula.live" className='underline text-purple-400'>Say Hi and send Resume with Job title.</a></h2>
    </div>
    <Faq/>
    </div>
  )
