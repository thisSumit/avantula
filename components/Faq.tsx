    ...
    return (
        <div>
            ...
            <div className='flex relative my-10 md:gap-10 gap-5 md:flex-row flex-col justify-between items-center'>
                ...
                <h1 className='text-4xl flex items-center sm:text-7xl font-extrabold mb-2 relative bg-clip-text text-transparent bg-gradient-to-b from-purple-500 to-purple-800'>AVANTULA</h1>
