...
const worldW = () => {
    ...
    <h2>Our Services</h2>
    <ul>
        <li><strong>Graphic Designing:</strong> We create visually compelling designs that effectively communicate your brand's message and engage your audience.</li>
        <li><strong>Video Editing:</strong> Our team crafts high-quality video content that captivates viewers and tells your brand's story in an impactful way.</li>
        ...
        <li><strong>Organic Content:</strong> Our content creation focuses on delivering valuable, SEO-optimized content that enhances your website's visibility and builds audience trust.</li>
        <li><strong>Website Development:</strong> We design and develop user-friendly websites that provide a seamless user experience and accurately reflect your brand's identity.</li>
