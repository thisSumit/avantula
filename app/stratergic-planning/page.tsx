...
export const metadata: Metadata = {
    ...
    description: "Stratergic Planning section of Avantula Creative Digital Marketing Agency",
    keywords: 'best digital marketing agency in India, Nagpur, Avantula Stratergic Planning'
  };
